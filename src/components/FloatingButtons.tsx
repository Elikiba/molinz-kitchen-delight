...
export const ScrollToTopButton = () => {
  ...
  useEffect(() => {
    const handleScroll = () => setShow(window.scrollY > 1200);
...
export const WhatsAppButton = () => {
  return (
    <motion.a
      href="https://wa.me/2348000000000?text=Hi%20Molinz%20Kitchen!%20I%20have%20a%20question%20about%20your%20menu."
      target="_blank"
